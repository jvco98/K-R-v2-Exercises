/*
	Exercise 4-10: An alternate organization uses getline to read an entire input line; this makes getch and ungetch unnecessary. Revice the calculator to use this approach.
*/
...
int lineIndex = 0;	// index for the line buffer
